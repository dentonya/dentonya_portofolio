...
// import HeroImage from "../assets/coding.avif";
    ...
    <div className="flex flex-col md:flex-row items-center max-w-7xl w-full gap-12 pt-20 sm:pt-32">
      ...
      <div className="w-full md:w-2/3 text-left space-y-6">
        ...
        <div className="mt-6 flex gap-4 flex-wrap">
          <button
            className="border-2 border-pink-500 px-6 py-2 rounded-lg hover:bg-pink-500"
          >
            CONTACT ME
          </button>
          <button
      ...
      <div className="w-full md:w-1/3 flex justify-center md:justify-end mt-8 md:mt-0">
        <AnimationLottie
          ...
          className="scale-200 sm:scale-125 md:scale-150 lg:scale-175"
        />
      </div>
    </div>
  </div>  
