  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid bg-gray sm:grid-cols-2 md:grid-cols-4 gap-8 px-12 sm:px-0">
          {techs.map(({ id, src, title, style }) => (
            <div
              key={id}
              className={`shadow-md bg-slate-800 hover:scale-105 duration-500 py-2 rounded-lg ${style}`}
            >
